...
def plot_returns(returns,
    ...
    **kwargs, optional
    ...
    #ax.set_xticks(txn_time.index[::int(120 / bin_minutes)])
    #ax.set_xticklabels(txn_time.time_str[::int(120 / bin_minutes)])
...
def plot_txn_time_hist(transactions, bin_minutes=30, tz='America/New_York',
                       ax=None, **kwargs):
    """
    ...
    **kwargs, optional
    ...
    txn_time = txn_time.groupby(level=0).sum().reindex(index=range(60, 1441))
